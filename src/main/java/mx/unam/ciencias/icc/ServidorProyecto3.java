...
import mx.unam.ciencias.icc.red.ServidorBaseDeDatosMascotas;
...
public class ServidorProyecto3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ServidorBaseDeDatosMascotas servidor;
            servidor = new ServidorBaseDeDatosMascotas(puerto, archivo);
